package com.example.intelligentchatbotservice;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for intelligentchatbotservice")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to intelligentchatbotservice";
    }
    ...
    public String info() {
        return "Spring Boot Application: intelligentchatbotservice";
    }
} 